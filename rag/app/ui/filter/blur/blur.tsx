...
export default function BlurFilter({ blurCap, tricolor, triggerAnimation, onComplete }: input) {
    ...
    const [click, setClick] = useState(triggerAnimation)

    useEffect(() => {
        setClick(triggerAnimation)
    }, [triggerAnimation])
        ...
        <div className="w-full h-full">
            <div className="absolute inset-0 w-full h-full pointer-events-none">
                ...
                <div
                    ...
                    className="absolute top-0 left-0 w-[150%] h-[150%] rounded-full translate-x-[-45%] translate-y-[20%] z-2"
                />
                <div
                    ref={leftRef}
                    style={{
